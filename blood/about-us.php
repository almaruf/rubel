...
?>
	<div class="container">
		<div class="row">
			<div class="full_width help">
				<br />
				<br />
				<h2 class="text-center">আমাদের বিষয়ে</h2>
				<hr />
				<p><strong>কেন করবেন?</strong></p>
